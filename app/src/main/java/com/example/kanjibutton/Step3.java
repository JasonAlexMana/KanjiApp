...
public class Step3 extends BaseActivity implements View.OnLongClickListener, View.OnDragListener {
...
//    View bottom_sheet;
    ...
    CardView imgvw, imgvw2, imgvw3, imgvw4;
    ...
    public void onBackPressed() {
        com.example.kanjibutton.ExitDialog cdd = new com.example.kanjibutton.ExitDialog(Step3.this);
        cdd.show();
    }
...
//                sheetDialog.show();
        ...
        imgvw = (CardView) findViewById(R.id.imgvw);
        imgvw.setTag("tag1");
        ...
        LinearLayout ll5 = findViewById(R.id.layout5);
        ll5.setTag("tag1");
...
//                    Toast.makeText(this, "progress "+progress, Toast.LENGTH_LONG).show();
                    ...
                    vw.setTag("done");
                    if (imgvw.getTag() == "done" && imgvw2.getTag() == "done" && imgvw3.getTag() == "done" && imgvw4.getTag() == "done") {
                        com.example.kanjibutton.Parameter.level3 = true;
                        com.example.kanjibutton.Parameter.current = 4;
...
//        title.setText("Level 3 Complete");
